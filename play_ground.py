...
a = np.load('test_results/DRL_results/incumbent_20x10[1,99]_fdd-divide-mwkr_yaoxin_1_128_4_4_gin+dghan_1_0.0_5e-05_10_500_64_128000_10/tai_30x20_fdd-divide-mwkr_result.npy')[-1]
b = np.load('test_data/tai30x20_result.npy')
