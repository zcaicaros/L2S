...
class RL2S4JSSP:
    ...
    def validation(self):
        # validating...
        states_val, feasible_actions_val, dones_val = self.env_validation.reset(instances=validation_data,
        ...
        while self.env_validation.itr < args.transit:
            ...
            states_val, rewards_vall, feasible_actions_val, dones_val = self.env_validation.step(actions_val,
                                                                                                 dev)
